...
class UVsim:
    def __init__(self, simulator):
        ...
        self.user_output_label = tk.Label(self.output_frame, text="User Output:",
                                          bg=self.primary_color, fg=get_contrasting_color(self.primary_color))
        self.user_output_label.pack()

        self.user_output_text = tk.Text(self.output_frame, wrap=tk.WORD, width=80,
        ...
        self.diagnostic_output_label = tk.Label(
            self.diagnostic_frame, text="Diagnostic Output:", bg=self.primary_color, fg=get_contrasting_color(self.primary_color))
        self.diagnostic_output_label.pack()

        self.diagnostic_output_text = tk.Text(
            self.diagnostic_frame, wrap=tk.WORD, width=80, height=10, bg=self.off_color, fg=get_contrasting_color(self.off_color))
    ...
    def create_menus(self):
        ...
        settings_menu.add_command(label="Color Scheme", command=lambda: set_color_scheme(
            self.root, self.user_output_text))
