...
def read(operand):
    global memory
    memory[operand] = int(
        input(f"Enter a number for memory location {operand}: "))
...
def load(operand):
    ...
    print(
        f"Loaded value {accumulator} from memory location {operand} into accumulator.")
...
def store(operand):
    ...
    print(
        f"Stored value {accumulator} from accumulator into memory location {operand}.")
...
def add(operand):
    ...
    accumulator += memory[operand]
    print(
        f"Added value from memory location {operand}, new accumulator value: {accumulator}")
    return accumulator
...
def subtract(operand, test=None):
    ...
    accumulator -= memory[operand]
    print(
        f"Subtracted value from memory location {operand}, new accumulator value: {accumulator}")
...
def divide(operand, test=None):
    ...
    accumulator //= memory[operand]
    print(
        f"Divided by value from memory location {operand}, new accumulator value: {accumulator}")
...
def multiply(operand, test=None):
    ...
    accumulator *= memory[operand]
    print(
        f"Multiplied by value from memory location {operand}, new accumulator value: {accumulator}")
...
def execute_instruction(instruction):
    ...
    print(
        f"Accumulator after executing instruction {instruction}: {accumulator}")
    print_memory()
    return False
...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            print(
                f"Error: File '{file}' contains invalid data. Please check the file and try again.")
